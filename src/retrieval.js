 ...
 * ---------------------------
 */
async function findRelevantChunks(question, cache) {
...
class SemanticRetrievalService {
    constructor(embeddingService, dbPathOrCache) {
    ...
    async rankCandidatesByQuery(query, candidateIds) {
    ...
    async findRelevantChunks(query, keywords, maxCandidates = 200, topK = 20) {
        let candidateChunks = [];
