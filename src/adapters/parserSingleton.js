...
var ParserSingleton = /** @class */ (function () {
    function ParserSingleton() {
        this.treeParser = null;
        this.language = null;
        this.initialized = false;
    }
    ParserSingleton.getInstance = function () {
        if (!ParserSingleton.instance) {
            ParserSingleton.instance = new ParserSingleton();
        }
        return ParserSingleton.instance;
    };
    ParserSingleton.prototype.init = function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var runtimePath, apexPath, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        runtimePath = context.asAbsolutePath("media/runtime/tree-sitter.wasm");
                        apexPath = context.asAbsolutePath("media/apex/tree-sitter-apex.wasm");
                        return [4 /*yield*/, Parser.init({ wasmPath: runtimePath })];
                    case 1:
                        _b.sent();
                        _a = this;
                        return [4 /*yield*/, Parser.Language.load(apexPath)];
                    case 2:
                        _a.language = _b.sent();
